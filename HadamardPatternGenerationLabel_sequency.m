...
H = hadamard_sequency(N); % Generate Hadamard matrix
...
print(fullfile(outputDir, [filename, 'HadamardMatrixLabeledSequency_', num2str(N), 'x', num2str(N)]), '-dpng', '-r300');
set(gcf,'Renderer','painters');
print(fullfile(outputDir, [filename, 'HadamardMatrixLabeledSequency_', num2str(N), 'x', num2str(N)]), '-deps');
...
print(fullfile(outputDir, [filename, 'HadamardPattersSequency_', num2str(N), 'x', num2str(N)]), '-dpng', '-r300');
set(gcf,'Renderer','painters');
print(fullfile(outputDir, [filename, 'HadamardPattersSequency_', num2str(N), 'x', num2str(N)]), '-deps');
...
print(fullfile(outputDir, [filename, 'HadamardMatrixLabeledSequency_', num2str(N), 'x', num2str(N)]), '-dpng', '-r300');
set(gcf,'Renderer','painters');
print(fullfile(outputDir, [filename, 'HadamardMatrixLabeledSequency_', num2str(N), 'x', num2str(N)]), '-depsc', '-r300');
...
print(fullfile(outputDir, [filename, 'HadamardPattersSequency02_', num2str(N), 'x', num2str(N)]), '-dpng', '-r300');
set(gcf,'Renderer','painters');
print(fullfile(outputDir, [filename, 'HadamardPattersSequency02_', num2str(N), 'x', num2str(N)]), '-deps');
...
print(fullfile(outputDir, [filename, 'HadamardPattersSequency03_', num2str(N), 'x', num2str(N)]), '-dpng', '-r300');
set(gcf,'Renderer','painters');
print(fullfile(outputDir, [filename, 'HadamardPattersSequency03_', num2str(N), 'x', num2str(N)]), '-deps');
%% Individual patterns Label
pat = ones(sqrt(N), sqrt(N)); % Placeholder for pattern
k = 1;                        % Row index counter

% Create Figure 3 at position (800,50) with size 400x400
fig8 = createFigure('left', 800, 'bottom', 50, 'width', 400, 'height', 400);
...
for row = 1 : sqrt(N)
    for col = 1 : sqrt(N)
        ...
        print(fullfile(outputDir, [filename, 'HadamardPattersSequency03_', num2str(N), 'x', num2str(N), '_', num2str(k) ]), '-dpng', '-r300');
        set(gcf,'Renderer','painters');
        print(fullfile(outputDir, [filename, 'HadamardPattersSequency03_', num2str(N), 'x', num2str(N), '_', num2str(k)]), '-deps');
        k = k + 1;                % Move to next row
    end
end
...
for row = 1 : sqrt(N)
    for col = 1 : sqrt(N)
        ...
        print(fullfile(outputDir, [filename, 'HadamardPattersSequencyPositive_', num2str(N), 'x', num2str(N), '_', num2str(k) ]), '-dpng', '-r300');
        set(gcf,'Renderer','painters');
        print(fullfile(outputDir, [filename, 'HadamardPattersSequencyPositive_', num2str(N), 'x', num2str(N), '_', num2str(k)]), '-deps');
        k = k + 1;                % Move to next row
    end
end
...
for row = 1 : sqrt(N)
    for col = 1 : sqrt(N)
        ...
        print(fullfile(outputDir, [filename, 'HadamardPattersSequencyNegative03_', num2str(N), 'x', num2str(N), '_', num2str(k) ]), '-dpng', '-r300');
        set(gcf,'Renderer','painters');
        print(fullfile(outputDir, [filename, 'HadamardPattersSequencyNegative03_', num2str(N), 'x', num2str(N), '_', num2str(k)]), '-deps');
        k = k + 1;                % Move to next row
    end
end
