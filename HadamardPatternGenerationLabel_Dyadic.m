...
H = hadamard_dyadic(N); % Generate Hadamard matrix
...
print(fullfile(outputDir, [filename, 'HadamardMatrixLabeledDyadic_', num2str(N), 'x', num2str(N)]), '-dpng', '-r300');
set(gcf,'Renderer','painters');
print(fullfile(outputDir, [filename, 'HadamardMatrixLabeledDyadic_', num2str(N), 'x', num2str(N)]), '-deps');
...
print(fullfile(outputDir, [filename, 'HadamardPattersDyadic_', num2str(N), 'x', num2str(N)]), '-dpng', '-r300');
set(gcf,'Renderer','painters');
print(fullfile(outputDir, [filename, 'HadamardPattersDyadic_', num2str(N), 'x', num2str(N)]), '-deps');
...
print(fullfile(outputDir, [filename, 'HadamardMatrixLabeledDyadic_', num2str(N), 'x', num2str(N)]), '-dpng', '-r300');
set(gcf,'Renderer','painters');
print(fullfile(outputDir, [filename, 'HadamardMatrixLabeledDyadic_', num2str(N), 'x', num2str(N)]), '-depsc', '-r300');
...
print(fullfile(outputDir, [filename, 'HadamardPattersDyadic02_', num2str(N), 'x', num2str(N)]), '-dpng', '-r300');
set(gcf,'Renderer','painters');
print(fullfile(outputDir, [filename, 'HadamardPattersDyadic02_', num2str(N), 'x', num2str(N)]), '-deps');
...
print(fullfile(outputDir, [filename, 'HadamardPattersDyadic03_', num2str(N), 'x', num2str(N)]), '-dpng', '-r300');
set(gcf,'Renderer','painters');
print(fullfile(outputDir, [filename, 'HadamardPattersDyadic03_', num2str(N), 'x', num2str(N)]), '-deps');
%%